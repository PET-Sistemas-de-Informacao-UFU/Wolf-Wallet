...
class App:
    ...
    DEVELOPER: str = "Matheus Gualter S. Resende"
    DEVELOPER_GITHUB: str = "https://github.com/MatheuxGualter"

    # Snippet HTML reutilizável — "Feito com ❤️ por ... [ícone GitHub]"
    CREDIT_HTML: str = (
        "<p style='text-align:center;color:gray;font-size:0.75rem;margin-top:0.4rem;'>"
        f"Feito com ❤️ por {DEVELOPER}"
        f"<a href='{DEVELOPER_GITHUB}' target='_blank' rel='noopener' "
        "title='GitHub — MatheuxGualter' "
        "style='color:inherit;text-decoration:none;margin-left:6px;vertical-align:middle;'>"
